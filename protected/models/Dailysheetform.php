...
class Dailysheetform extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('beginningcash, cashdeposit, total', 'numerical'),
			array('supervisorname, verifiedby, preparedby', 'length', 'max'=>128),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, date, beginningcash, supervisorname, denomination1000, denomination500, denomination200, denomination100, denomination50, denomination20, denomination10, denomination5, denomination1, denomination50c, denomination25c, denomination10c, denomination5c, denomination1c, cashcensus_laboratory, cashcensus_ancillary, cashcensus_consultation, hmocensus_laboratory, hmocensus_ancillary, hmocensus_consultation, cashdeposit, total, verifiedby, preparedby', 'safe', 'on'=>'search'),
		);
	}
