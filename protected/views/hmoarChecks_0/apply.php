...
$(document).ready(function() {
    ...
    initTrnxsGrid("Unpaid Trnxs", "#tblUntrnxs", "#pgrUntrnxs",""); 
...
<div id="midwrap" style="display: table;width:100%">
    <div id="paidwrap" style="float:left;dwidth:48%;border:1px solid lightblue;margin-right:10px">
    ...
    <div id="unpaidwrap" style="float:left;width:48%;border:1px solid lightblue;padding:3px;">

                <fieldset style="border:1px solid royalblue;">
                    <legend class="blue">Search Unpaid Transactions</legend>
                    <table>
                        <tr>
