...
class MaxiCareController extends Controller
{
    ...
    private function printSoaSummary($hmo_bill_id)
    {
           ...
           $print = implode("", file(Yii::app()->getBasePath().'/modules/MaxiCare/html/dprintSummary.html')); 
    ...
    {
            $connection=Yii::app()->db;   
            $print = implode("", file(Yii::app()->getBasePath().'/modules/MaxiCare/html/dprintApe.html'));            
