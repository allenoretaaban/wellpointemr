...
class PdsController extends RController
{
	...
	public function actionAdmin()
	{
        ...
        public function actionPrint()
        {
			...
			// contact number
			$contact = '';
            (trim($patient->mobile_no) != '') ? $contact .= trim($patient->mobile_no).'' : $contact.='' ;
			if(trim($patient->mobile_no) != ''){
				(trim($patient->tel_no) != '') ? $contact .= ' / '.trim($patient->tel_no).'' : $contact.='' ;
			}else{
				(trim($patient->tel_no) != '') ? $contact .= ''.trim($patient->tel_no).'' : $contact.='' ;
			}
            $print = str_replace("[contact_number]",$contact,$print);
			
            $print = str_replace("[spouse]",$patient->spousename,$print); // spouse name		
            $print = str_replace("[spouseoccupation]",$patient->spouseoccupation,$print); // spouse occupation	
            $print = str_replace("[emergencyperson]",$patient->emergencycontactname,$print); // emergency person
            $print = str_replace("[emergencypersonrelation]",$patient->emergencycontactrelation,$print); // emergency person relation
            $print = str_replace("[emergencycontactaddress]",$patient->emergencycontactaddress,$print); // emergency person relation address
            $print = str_replace("[emergencycontactnos]",$patient->emergencycontactnos,$print); // emergency person relation contact
        ...
        public function actionPrintForm2()
        {
            ...
            $print = str_replace("[spouse_name]",$patient->spousename,$print); // spouse name			
            $print = str_replace("[spouseoccupation]",$patient->spouseoccupation,$print); // spouse occupation			
            $print = str_replace("[emergencyperson]",$patient->emergencycontactname,$print); // emergency person
            $print = str_replace("[emergencypersonrelation]",$patient->emergencycontactrelation,$print); // emergency person relation
            $print = str_replace("[emergencycontactaddress]",$patient->emergencycontactaddress,$print); // emergency person relation address
        ...
        public function actionPrintFollowUp()
        {
            ...
            (trim($patient->barangay) != '') ? $add2 .= trim($patient->barangay).', ' : $add2.='' ;
