...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        ...
        <?php echo $form->dropDownList($model, 'bank_id', CHtml::listData(HmoarBanks::model()->findAll(), 'bankid', 'bank_title')); ?>
	...
	<div class="row">
        ...
        <?php echo $form->dropDownList($model, 'hmo_id', CHtml::listData(Hmo::model()->findAll(), 'id', 'name')); ?>
