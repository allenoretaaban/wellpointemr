...
<?php $form=$this->beginWidget('CActiveForm', array(
			...
			<td>
				...
				<?php 
					if($model->is_categorized == 1){
			            ...
			            $query = "select * from hmo_form_items_category where hmo_form_item_id = ".(int)$model->itemid." order by itemid asc";
	...
	<div class="row buttons">
		&nbsp;<input type="Button" value="Back" onclick="window.location = '/hmoForm/<?=$model->hmo_form_id ?>'">
