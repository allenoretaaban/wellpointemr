...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        <?php echo $form->labelEx($model,'cashdeposit'); ?>
        <?php echo $form->textField($model,'cashdeposit'); ?>
        <?php echo $form->error($model,'cashdeposit'); ?>
    </div>
    ...
    <fieldset>
        ...
        <fieldset>
            ...
            <div class="newline">
	            ...
	            <div class="row line">
		            <?php echo $form->labelEx($model,'denomination1c'); ?>
		            <?php echo $form->textField($model,'denomination1c'); ?>
		            <?php echo $form->error($model,'denomination1c'); ?>
	            </div>
            </div>
        </fieldset>
    </fieldset>
    ...
    <fieldset>
        <legend>Cash Census</legend>
        <div class="row">
            <?php echo $form->labelEx($model,'cashcensus_laboratory'); ?>
            <?php echo $form->textField($model,'cashcensus_laboratory'); ?>
            <?php echo $form->error($model,'cashcensus_laboratory'); ?>
        </div>
        <div class="row">
            <?php echo $form->labelEx($model,'cashcensus_ancillary'); ?>
            <?php echo $form->textField($model,'cashcensus_ancillary'); ?>
            <?php echo $form->error($model,'cashcensus_ancillary'); ?>
        </div>
        <div class="row">
            <?php echo $form->labelEx($model,'cashcensus_consultation'); ?>
            <?php echo $form->textField($model,'cashcensus_consultation'); ?>
            <?php echo $form->error($model,'cashcensus_consultation'); ?>
        </div>
    </fieldset>
