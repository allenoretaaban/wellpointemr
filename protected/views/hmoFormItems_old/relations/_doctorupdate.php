<div class="form"  name="hmoitems_doctor">
	...
	<div class="row">
		<?php echo $form->hiddenField($model,'hmo_form_id', array('value'=>$model->hmo_form_id)); ?>
	</div>
	...
	<div class="row">
        ...
        <?php echo $form->dropDownList($model,'service_type',array('CONSULTATION'=>'Consultation (PF)','PROCEDURE'=>'Procedure','OTHERS'=>'Consultation/Procedure')); ?>
