...
class PdsController extends RController
{
    ...
    public function actionCreateWithDoctor()
    {
                ...
                if(isset($_POST['Pds']))
                {
                        $model->attributes=$_POST['Pds'];
                        $model->patient_id=$_GET['id'];
                        $doctor_model=Doctor::model()->findByPk($model->doctor);
                        $model->doctor=$doctor_model->fullName;
                        if ($model->hmo == '')
                        {
                            $model->hmo='';
                        } else
    ...
    public function actionCensus()
    {
        ...
        public function actionPrint()
        {
            ...
            $patient = $pds->patient;        
            $print = implode("", file(Yii::app()->getBasePath().'\views\pds\include\Revised.FINAL FORMS.per.sheet.htm'));
