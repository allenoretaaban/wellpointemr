    ...
    $patientid="";
        ...
        if($_POST["patientval"]){
            ...
            $du = Yii::app()->db->createCommand()
                ...
                ->queryRow();
            $patientid = $_POST["DiagResBloodchem"]['patient_id'];
...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">        
        <?php echo $form->hiddenField($model,'patient_id', array('value'=>$patientid) ); ?>        
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model,'patient_name',array('size'=>60,'maxlength'=>250,'value'=>strtoupper($fullpatientname),'readonly'=>'readonly')); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model,'gender',array('size'=>10,'maxlength'=>250,'value'=>$sex,'readonly'=>'readonly')); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model,'medtech',array('size'=>60,'maxlength'=>250,'readonly'=>'readonly')); ?>
        <?php echo $form->error($model,'medtech'); ?>
    </div>
    
    <div class="row">
        <?php echo $form->labelEx($model,'medtech_license'); ?>
        <?php echo $form->textField($model,'medtech_license',array('size'=>60,'maxlength'=>250,'readonly'=>'readonly')); ?>
