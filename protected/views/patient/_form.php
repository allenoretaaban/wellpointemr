...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <fieldset>
            ...
            <div class="row line">
                <?php echo $form->labelEx($model,'positionapplyingfor'); ?>
                <?php echo $form->textField($model,'positionapplyingfor',array('size'=>20,'maxlength'=>255)); ?>
                <?php echo $form->error($model,'positionapplyingfor'); ?>
            </div>
        </fieldset>
        <fieldset>
